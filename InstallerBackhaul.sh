...
install_core() {
    ...
    cd backhaul
    if [ "$arch" == "x86_64" ]; then
        wget https://github.com/Musixal/Backhaul/releases/download/v0.3.2/backhaul_linux_amd64.tar.gz
        tar -xf backhaul_linux_amd64.tar.gz
        rm backhaul_linux_amd64.tar.gz
    elif [ "$arch" == "aarch64" ]; then
        wget https://github.com/Musixal/Backhaul/releases/download/v0.3.2/backhaul_darwin_arm64.tar.gz
